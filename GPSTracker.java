...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 5 * 1; // 1 minute x  10seconds

    // Declaring a Location Manage
    ...
    @Override
    public void onLocationChanged(Location location) { // 위치가 변경되었을때 실행
        if(location != null){
    ...
    public void onProviderDisabled(String provider) {
        ...
        mHandler.sendEmptyMessage(MapsActivity.RENEW_GPS);
    ...
    private void sendString(String str){
        ...
        msg.what = MapsActivity.SEND_PRINT;
